...
export declare function getD3Transition(selection: D3Selection, duration?: number, ease?: (t: number) => number, onEnd?: () => void): D3Selection | import("d3-transition").Transition<HTMLDivElement, unknown, null, undefined>;
